...
function MyTable() {
    ...
    return (
        <div className='d-flex flex-column justify-content-center align-items-center m-5 p-3' style={{ height: '100vh', width: '200vh'}}>
       ...
       <Search/>
            <div className='w-100 bg-white p-4 rounded ' style={{ borderRadius: '20px', overflow: 'hidden' }}>
                <Table bordered hover className='mb-0 ' style={{ borderRadius: '20px', overflow: 'hidden', fontSize: '1.3rem'  }}>
                    <thead>
                        <tr>
                            <th className="my-sm-5 bg-info text-center">STT</th>
                            <th className="my-sm-5 bg-info text-center">Tên sinh viên</th>
                            <th className="my-sm-5 bg-info text-center">Mã máy in</th>
